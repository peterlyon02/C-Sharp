...
namespace Lab02
{
	internal class Developer : Employee
	{
		...
		{
			Console.WriteLine($"Nome: {this.Name} - Cognome: {this.LastName} - Data di nascita: {this.birthDate} - Posizione: {this.JobTitle} - Linguaggio di programmazione: {this.Skills}");
		}
	}
}
